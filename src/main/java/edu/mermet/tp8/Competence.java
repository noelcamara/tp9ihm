...
public class Competence {
	...
	/**
	 * Constructeur avec paramettre (creer un nouvelle competence a partir d'une donnee)
	 * @param competence
	 */
	...
	/**
	 * Ajout de la competence de 0.1 pour chaque utilisation de quitter jusqu'a ce que la competence egale a 4
	 */
	...
	/**
	 * ajout de la competence avec 0.2 pour l'utilisation du diaporama apres avoir depasser 2 et s'arrete en atteignant la competence 8 
	 */
